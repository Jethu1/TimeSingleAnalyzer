...
public class IndexTest4 {
    static Logger logger = LogManager.getLogger(IndexTest4.class.getName());
    @Test
    public void index() throws IOException {
        //create a indexWriter"
        Directory directory = FSDirectory.open(new File("300index"));
...
//        indexWriter.forceMerge(5);
        ...
        for (int m = 0; m < 3000; m++) {
            for (int i = 0; i < 100; i++) {
                ...
                doc[10*i].add(new FloatField("IntV", 2.5f, Field.Store.YES));
                ...
                doc[10*i+1].add(new FloatField("IntV", 3.5f, Field.Store.YES));
                ...
                doc[10*i+2].add(new FloatField("IntV", 4.5f, Field.Store.YES));
                ...
                doc[10*i+3].add(new FloatField("IntV", 5.5f, Field.Store.YES));
                ...
                doc[10*i+4].add(new FloatField("IntV", 6.5f, Field.Store.YES));
                ...
                doc[10*i+5].add(new FloatField("IntV", 7.5f, Field.Store.YES));
                ...
                doc[10*i+6].add(new FloatField("IntV", 8.5f, Field.Store.YES));
                ...
                doc[10*i+7].add(new FloatField("IntV", 9.5f, Field.Store.YES));
                ...
                doc[10*i+8].add(new FloatField("IntV", 10.5f, Field.Store.YES));
                ...
                doc[10*i+9].add(new FloatField("IntV", 11.5f, Field.Store.YES));
